...
**Decision (2026-09-24, with the reporter): close it in the backend — the direct route files a request instead of writing.** Full design plan, including the app-side contract and a financial-integrity finding that outranks the reported bug: **[TASK-17-US11-profile-edit-design.md](TASK-17-US11-profile-edit-design.md)**. This is the largest item in the batch and the only one needing a migration:
