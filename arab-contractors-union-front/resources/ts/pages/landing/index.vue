...
const testimonials = [
  { name: 'م. أحمد محمود الخطيب', title: 'مدير شركة الخطيب للمقاولات', city: 'رام الله', text: 'منذ انضمامنا لاتحاد المقاولين الفلسطينيين، تضاعفت فرصنا في الحصول على العطاءات الحكومية. الاتحاد يمثلنا بشكل حقيقي أمام الجهات الرسمية ويحمي حقوقنا.', rating: 5 },
...
const faqs = [
  ...
  { q: 'ما هي مزايا العضوية في اتحاد المقاولين الفلسطينيين؟', a: 'تشمل المزايا: شهادات التصنيف المعتمدة، التمثيل أمام الجهات الحكومية، الوصول للعطاءات الحكومية، البرامج التدريبية المتخصصة، الاستشارات القانونية والفنية، وخدمة تسوية النزاعات والتحكيم.' },
...
const stats = ref([
  ...
  { target: 0, suffix: '+', label: 'عطاء مفتوح',       icon: ClipboardList, color: '#c62828' },
...
const services = [
  ...
  { icon: Megaphone,     title: 'العطاءات',            desc: 'اطلع على أحدث العطاءات الحكومية والمشاريع المتاحة للقطاع.',                href: '/public-tenders' },
