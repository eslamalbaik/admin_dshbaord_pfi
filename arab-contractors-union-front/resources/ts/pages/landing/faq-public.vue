...
const faqs = [
  ...
  },
  {
    ...
    a: 'يستفيد أعضاء الاتحاد من: شهادة تصنيف معترف بها، الاستشارات القانونية المجانية، الأولوية في المناقصات الحكومية، الخصومات على برامج التدريب، والتمثيل الرسمي أمام الجهات الرسمية.',
  },
  {
    id: 4, cat: 'التصنيف',
  ...
  },
  {
    ...
    a: 'نعم، شهادات التصنيف الصادرة عن اتحاد المقاولين الفلسطينيين معترف بها في إطار اتفاقيات التبادل مع اتحاد المقاولين العرب والدولي، وتُقبل في أغلب المناقصات التي تموّلها الجهات الدولية.',
  },
  {
    id: 7, cat: 'المناقصات',
    q: 'كيف يمكنني الاطلاع على المناقصات المتاحة؟',
    a: 'يمكنك الاطلاع على أحدث المناقصات عبر صفحة "المناقصات والعطاءات" في موقعنا. يتم تحديثها بشكل يومي ويمكنك التصفية حسب القطاع والموقع وحالة المناقصة.',
  },
  {
    id: 8, cat: 'المناقصات',
    q: 'هل يساعد الاتحاد في تحضير عروض المناقصات؟',
