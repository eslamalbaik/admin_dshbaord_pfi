...
class Tender extends Model
{
    ...
    /**
     * التصنيفات الأولية فقط — التصنيفات الفعلية صارت في جدول tender_categories وتُدار من لوحة
     * التحكم (TenderCategory). يبقى الثابت لبذور البيانات وmigration قديم يعتمد عليه.
     */
