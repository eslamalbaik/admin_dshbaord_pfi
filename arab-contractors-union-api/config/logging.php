...
return [
    ...
    */
    ...
    'channels' => [
        ...
        // سجل تدقيق مالي: إنشاء/تعديل/تسوية الذمم وتأكيد الدفعات مع أسعار الصرف
        'finance' => [
            'driver' => 'daily',
        ...
        // ملخص تشغيلات تذكيرات تجديد العضوية
        'reminders' => [
            'driver' => 'daily',
        ...
        // رسائل SMS الصادرة (خصوصاً بوضع log قبل التعاقد مع مزود)
        'sms' => [
            'driver' => 'daily',
